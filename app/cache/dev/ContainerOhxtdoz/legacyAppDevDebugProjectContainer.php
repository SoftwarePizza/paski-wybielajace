 ...
 */
class legacyAppDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'tpay' => 'getTpayService.php',
            'tpay.cart' => 'getTpay_CartService.php',
            'tpay.context' => 'getTpay_ContextService.php',
            'tpay.controller' => 'getTpay_ControllerService.php',
            'tpay.cookie' => 'getTpay_CookieService.php',
            'tpay.currency' => 'getTpay_CurrencyService.php',
            'tpay.handler.install_query_handler' => 'getTpay_Handler_InstallQueryHandlerService.php',
            'tpay.handler.order_status_handler' => 'getTpay_Handler_OrderStatusHandlerService.php',
            'tpay.handler.repository_query_handler' => 'getTpay_Handler_RepositoryQueryHandlerService.php',
            'tpay.language' => 'getTpay_LanguageService.php',
            'tpay.link' => 'getTpay_LinkService.php',
            'tpay.order_history' => 'getTpay_OrderHistoryService.php',
            'tpay.repository.blik' => 'getTpay_Repository_BlikService.php',
            'tpay.repository.credit_card' => 'getTpay_Repository_CreditCardService.php',
            'tpay.repository.refund' => 'getTpay_Repository_RefundService.php',
            'tpay.repository.transaction' => 'getTpay_Repository_TransactionService.php',
            'tpay.service.card_service' => 'getTpay_Service_CardServiceService.php',
            'tpay.service.surcharge' => 'getTpay_Service_SurchargeService.php',
            'tpay.service.transaction' => 'getTpay_Service_TransactionService.php',
            'tpay.shop' => 'getTpay_ShopService.php',
            'tpay.smarty' => 'getTpay_SmartyService.php',
            'tpay.util.secret_hash' => 'getTpay_Util_SecretHashService.php',
        ...
        $this->privates = [
            ...
            'tpay' => true,
            'tpay.handler.install_query_handler' => true,
            'tpay.handler.repository_query_handler' => true,
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('i8flUnY4fG', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('rqTzwvCI7l', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => 'aylonxxnew.mysql.db', 'port' => '', 'dbname' => 'aylonxxnew', 'user' => 'aylonxxnew', 'password' => 'RTuu8973KLLac', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))', 1013 => $this->getEnv('const:runtime:_PS_ALLOW_MULTI_STATEMENTS_QUERIES_')], 'defaultTableOptions' => []], $a, $c, ['enum' => 'string']);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $d = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => ($this->targetDirs[3].'/modules/tpay/src/Entity'), 1 => ($this->targetDirs[3].'/src/PrestaShopBundle/Entity')]);
        ...
        $b->addDriver($d, 'Tpay\\Entity');
        $b->addDriver($d, 'PrestaShopBundle\\Entity');
        $b->addDriver($e, 'PrestaShop\\Module\\ProductComment\\Entity');
        $b->addDriver($f, 'PrestaShop\\Module\\PrestashopCheckout\\Entity');
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => ($this->targetDirs[3].'/modules/tpay/src/Entity')]), 'Tpay\\Entity');

        $a->setEntityNamespaces(['Tpay' => 'Tpay\\Entity', 'PrestaShopBundle' => 'PrestaShopBundle\\Entity']);
        ...
        $a->addEntityNamespace('Moduletpay', 'Tpay\\Entity');
    ...
    protected function getProfilerService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpKernel\DataCollector\LoggerDataCollector($a, ($this->targetDirs[0].'/legacyAppDevDebugProjectContainer')));
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('boJzy8sDo5', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('A9OtiQ53kB', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator(${($_ = isset($this->services['file_locator']) ? $this->services['file_locator'] : ($this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator(${($_ = isset($this->services['kernel']) ? $this->services['kernel'] : $this->get('kernel', 1)) && false ?: '_'}, ($this->targetDirs[2].'/Resources'), [0 => $this->targetDirs[2]]))) && false ?: '_'}, $this->targetDirs[0]);
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        }]), new \Symfony\Component\Translation\Formatter\MessageFormatter(new \Symfony\Component\Translation\MessageSelector()), 'pl-PL', ['translation.loader.php' => [0 => 'php'], 'translation.loader.yml' => [0 => 'yaml', 1 => 'yml'], 'translation.loader.xliff' => [0 => 'xlf', 1 => 'xliff'], 'translation.loader.po' => [0 => 'po'], 'translation.loader.mo' => [0 => 'mo'], 'translation.loader.qt' => [0 => 'ts'], 'translation.loader.csv' => [0 => 'csv'], 'translation.loader.res' => [0 => 'res'], 'translation.loader.dat' => [0 => 'dat'], 'translation.loader.ini' => [0 => 'ini'], 'translation.loader.json' => [0 => 'json'], 'prestashop.translation.database_loader' => [0 => 'db'], 'prestashop.translation.loader.legacy_file' => [0 => 'legacy_files'], 'prestashop.translation.legacy_file_loader' => [0 => 'legacy_files']], ['cache_dir' => ($this->targetDirs[0].'/translations'), 'debug' => true, 'resource_files' => ['af' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.af.xlf')], 'ar' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ar.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ar.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ar.xlf')], 'az' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.az.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.az.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.az.xlf')], 'be' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.be.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.be.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.be.xlf')], 'bg' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.bg.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.bg.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.bg.xlf')], 'bs' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.bs.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.bs.xlf')], 'ca' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ca.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ca.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ca.xlf')], 'cs' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.cs.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.cs.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.cs.xlf')], 'cy' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.cy.xlf')], 'da' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.da.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.da.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.da.xlf')], 'de' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.de.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.de.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.de.xlf')], 'el' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.el.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.el.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.el.xlf')], 'en' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.en.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.en.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.en.xlf')], 'es' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.es.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.es.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.es.xlf')], 'et' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.et.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.et.xlf')], 'eu' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.eu.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.eu.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.eu.xlf')], 'fa' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fa.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fa.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.fa.xlf')], 'fi' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fi.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fi.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.fi.xlf')], 'fr' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fr.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.fr.xlf')], 'gl' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.gl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.gl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.gl.xlf')], 'he' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.he.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.he.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.he.xlf')], 'hr' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hr.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.hr.xlf')], 'hu' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hu.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hu.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.hu.xlf')], 'hy' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hy.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hy.xlf')], 'id' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.id.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.id.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.id.xlf')], 'it' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.it.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.it.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.it.xlf')], 'ja' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ja.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ja.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ja.xlf')], 'lb' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lb.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lb.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.lb.xlf')], 'lt' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lt.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lt.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.lt.xlf')], 'lv' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lv.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lv.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.lv.xlf')], 'mn' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.mn.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.mn.xlf')], 'nb' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.nb.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.nb.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.nb.xlf')], 'nl' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.nl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.nl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.nl.xlf')], 'nn' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.nn.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.nn.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.nn.xlf')], 'no' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.no.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.no.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.no.xlf')], 'pl' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.pl.xlf')], 'pt' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pt.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pt.xlf')], 'pt_BR' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pt_BR.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pt_BR.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.pt_BR.xlf')], 'ro' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ro.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ro.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ro.xlf')], 'ru' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ru.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ru.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ru.xlf')], 'sk' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sk.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sk.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sk.xlf')], 'sl' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sl.xlf')], 'sq' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sq.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sq.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sq.xlf')], 'sr_Cyrl' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sr_Cyrl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sr_Cyrl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sr_Cyrl.xlf')], 'sr_Latn' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sr_Latn.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sr_Latn.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sr_Latn.xlf')], 'sv' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sv.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sv.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sv.xlf')], 'th' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.th.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.th.xlf')], 'tl' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.tl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.tl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.tl.xlf')], 'tr' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.tr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.tr.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.tr.xlf')], 'uk' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.uk.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.uk.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.uk.xlf')], 'vi' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.vi.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.vi.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.vi.xlf')], 'zh_CN' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.zh_CN.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.zh_CN.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.zh_CN.xlf')], 'zh_TW' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.zh_TW.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.zh_TW.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.zh_TW.xlf')], 'pt_PT' => [0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.pt_PT.xlf')], 'en-US' => [0 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminActions.en-US.xlf'), 1 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminAdvparametersFeature.en-US.xlf'), 2 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminAdvparametersHelp.en-US.xlf'), 3 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminAdvparametersNotification.en-US.xlf'), 4 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminCatalogFeature.en-US.xlf'), 5 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminCatalogHelp.en-US.xlf'), 6 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminCatalogNotification.en-US.xlf'), 7 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminDashboardFeature.en-US.xlf'), 8 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminDashboardHelp.en-US.xlf'), 9 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminDashboardNotification.en-US.xlf'), 10 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminDesignFeature.en-US.xlf'), 11 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminDesignHelp.en-US.xlf'), 12 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminDesignNotification.en-US.xlf'), 13 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminGlobal.en-US.xlf'), 14 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminGlobalError.en-US.xlf'), 15 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminInternationalFeature.en-US.xlf'), 16 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminInternationalHelp.en-US.xlf'), 17 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminInternationalNotification.en-US.xlf'), 18 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminLoginFeature.en-US.xlf'), 19 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminLoginNotification.en-US.xlf'), 20 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminModulesFeature.en-US.xlf'), 21 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminModulesHelp.en-US.xlf'), 22 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminModulesNotification.en-US.xlf'), 23 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminNavigationFooter.en-US.xlf'), 24 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminNavigationHeader.en-US.xlf'), 25 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminNavigationMenu.en-US.xlf'), 26 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminNavigationNotification.en-US.xlf'), 27 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminNavigationSearch.en-US.xlf'), 28 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminNotificationsError.en-US.xlf'), 29 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminNotificationsInfo.en-US.xlf'), 30 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminNotificationsSuccess.en-US.xlf'), 31 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminNotificationsWarning.en-US.xlf'), 32 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminOrderscustomersFeature.en-US.xlf'), 33 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminOrderscustomersHelp.en-US.xlf'), 34 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminOrderscustomersNotification.en-US.xlf'), 35 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminPaymentFeature.en-US.xlf'), 36 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminPaymentHelp.en-US.xlf'), 37 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminPaymentNotification.en-US.xlf'), 38 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminShippingFeature.en-US.xlf'), 39 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminShippingHelp.en-US.xlf'), 40 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminShippingNotification.en-US.xlf'), 41 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminShopparametersFeature.en-US.xlf'), 42 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminShopparametersHelp.en-US.xlf'), 43 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminShopparametersNotification.en-US.xlf'), 44 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminStatsFeature.en-US.xlf'), 45 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminStatsHelp.en-US.xlf'), 46 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminStatsNotification.en-US.xlf'), 47 => ($this->targetDirs[2].'/Resources/translations/en-US/EmailsBody.en-US.xlf'), 48 => ($this->targetDirs[2].'/Resources/translations/en-US/EmailsSubject.en-US.xlf'), 49 => ($this->targetDirs[2].'/Resources/translations/en-US/GlobalActions.en-US.xlf'), 50 => ($this->targetDirs[2].'/Resources/translations/en-US/Install.en-US.xlf'), 51 => ($this->targetDirs[2].'/Resources/translations/en-US/ModuleWatermarkAdmin.en-US.xlf'), 52 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesAdvertisingAdmin.en-US.xlf'), 53 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesAutoupgradeAdmin.en-US.xlf'), 54 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesBannerAdmin.en-US.xlf'), 55 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesBannerShop.en-US.xlf'), 56 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesBestsellersAdmin.en-US.xlf'), 57 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesBestsellersShop.en-US.xlf'), 58 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesBlockreassuranceAdmin.en-US.xlf'), 59 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesBlockreassuranceShop.en-US.xlf'), 60 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesBlockwishlistAdmin.en-US.xlf'), 61 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesBlockwishlistShop.en-US.xlf'), 62 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesBrandlistAdmin.en-US.xlf'), 63 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesBrandlistShop.en-US.xlf'), 64 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesBuybuttonliteAdmin.en-US.xlf'), 65 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesCarriercomparisonAdmin.en-US.xlf'), 66 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesCarriercomparisonShop.en-US.xlf'), 67 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesCashondeliveryAdmin.en-US.xlf'), 68 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesCashondeliveryShop.en-US.xlf'), 69 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesCategoryproductsAdmin.en-US.xlf'), 70 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesCategoryproductsShop.en-US.xlf'), 71 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesCategorytreeAdmin.en-US.xlf'), 72 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesCheckpaymentAdmin.en-US.xlf'), 73 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesCheckpaymentShop.en-US.xlf'), 74 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesContactformAdmin.en-US.xlf'), 75 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesContactformShop.en-US.xlf'), 76 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesContactinfoAdmin.en-US.xlf'), 77 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesContactinfoShop.en-US.xlf'), 78 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesCrosssellingAdmin.en-US.xlf'), 79 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesCrosssellingShop.en-US.xlf'), 80 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesCurrencyselectorAdmin.en-US.xlf'), 81 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesCustomeraccountlinksAdmin.en-US.xlf'), 82 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesCustomersigninAdmin.en-US.xlf'), 83 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesCustomtextAdmin.en-US.xlf'), 84 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesDashactivityAdmin.en-US.xlf'), 85 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesDashgoalsAdmin.en-US.xlf'), 86 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesDashproductsAdmin.en-US.xlf'), 87 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesDashtrendsAdmin.en-US.xlf'), 88 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesDataprivacyAdmin.en-US.xlf'), 89 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesDataprivacyShop.en-US.xlf'), 90 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesDateofdeliveryAdmin.en-US.xlf'), 91 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesDateofdeliveryShop.en-US.xlf'), 92 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesEmailalertsAdmin.en-US.xlf'), 93 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesEmailalertsShop.en-US.xlf'), 94 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesEmailsubscriptionAdmin.en-US.xlf'), 95 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesEmailsubscriptionShop.en-US.xlf'), 96 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesFacetedsearchAdmin.en-US.xlf'), 97 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesFacetedsearchShop.en-US.xlf'), 98 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesFaviconnotificationboAdmin.en-US.xlf'), 99 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesFeaturedproductsAdmin.en-US.xlf'), 100 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesFeaturedproductsShop.en-US.xlf'), 101 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesFeederAdmin.en-US.xlf'), 102 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesGAnalyticsAdmin.en-US.xlf'), 103 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesGraphnvd3Admin.en-US.xlf'), 104 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesGridhtmlAdmin.en-US.xlf'), 105 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesGsitemapAdmin.en-US.xlf'), 106 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesImagesliderAdmin.en-US.xlf'), 107 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesLanguageselectorAdmin.en-US.xlf'), 108 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesLegalcomplianceAdmin.en-US.xlf'), 109 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesLegalcomplianceShop.en-US.xlf'), 110 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesLinklistAdmin.en-US.xlf'), 111 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesLinklistShop.en-US.xlf'), 112 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesLivetranslationAdmin.en-US.xlf'), 113 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesLivetranslationShop.en-US.xlf'), 114 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesMailalertsAdmin.en-US.xlf'), 115 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesMailalertsShop.en-US.xlf'), 116 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesMainmenuAdmin.en-US.xlf'), 117 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesNewproductsAdmin.en-US.xlf'), 118 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesNewproductsShop.en-US.xlf'), 119 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesNewsletterAdmin.en-US.xlf'), 120 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesPagesnotfoundAdmin.en-US.xlf'), 121 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesProductcommentsAdmin.en-US.xlf'), 122 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesProductcommentsShop.en-US.xlf'), 123 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesProductinfoAdmin.en-US.xlf'), 124 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesPscleanerAdmin.en-US.xlf'), 125 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesReminderAdmin.en-US.xlf'), 126 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesRssfeedAdmin.en-US.xlf'), 127 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesRssfeedShop.en-US.xlf'), 128 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesSearchbarAdmin.en-US.xlf'), 129 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesSearchbarShop.en-US.xlf'), 130 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesSekeywordsAdmin.en-US.xlf'), 131 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesSharebuttonsAdmin.en-US.xlf'), 132 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesSharebuttonsShop.en-US.xlf'), 133 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesShoppingcartAdmin.en-US.xlf'), 134 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesSocialfollowAdmin.en-US.xlf'), 135 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesSocialfollowShop.en-US.xlf'), 136 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesSpecialsAdmin.en-US.xlf'), 137 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesSpecialsShop.en-US.xlf'), 138 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesStatsbestcategoriesAdmin.en-US.xlf'), 139 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesStatsbestcustomersAdmin.en-US.xlf'), 140 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesStatsbestmanufacturersAdmin.en-US.xlf'), 141 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesStatsbestproductsAdmin.en-US.xlf'), 142 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesStatsbestsuppliersAdmin.en-US.xlf'), 143 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesStatsbestvouchersAdmin.en-US.xlf'), 144 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesStatscarrierAdmin.en-US.xlf'), 145 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesStatscatalogAdmin.en-US.xlf'), 146 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesStatscheckupAdmin.en-US.xlf'), 147 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesStatsdataAdmin.en-US.xlf'), 148 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesStatsequipmentAdmin.en-US.xlf'), 149 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesStatsforecastAdmin.en-US.xlf'), 150 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesStatsliveAdmin.en-US.xlf'), 151 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesStatsnewsletterAdmin.en-US.xlf'), 152 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesStatsoriginAdmin.en-US.xlf'), 153 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesStatspersonalinfosAdmin.en-US.xlf'), 154 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesStatsproductAdmin.en-US.xlf'), 155 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesStatsregistrationsAdmin.en-US.xlf'), 156 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesStatssalesAdmin.en-US.xlf'), 157 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesStatssearchAdmin.en-US.xlf'), 158 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesStatsstockAdmin.en-US.xlf'), 159 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesStatsvisitsAdmin.en-US.xlf'), 160 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesSupplierlistAdmin.en-US.xlf'), 161 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesSupplierlistShop.en-US.xlf'), 162 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesTrackingfrontAdmin.en-US.xlf'), 163 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesTrackingfrontShop.en-US.xlf'), 164 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesViewedproductAdmin.en-US.xlf'), 165 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesViewedproductShop.en-US.xlf'), 166 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesWatermarkAdmin.en-US.xlf'), 167 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesWelcomeAdmin.en-US.xlf'), 168 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesWirepaymentAdmin.en-US.xlf'), 169 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesWirepaymentShop.en-US.xlf'), 170 => ($this->targetDirs[2].'/Resources/translations/en-US/ShopDemoCatalog.en-US.xlf'), 171 => ($this->targetDirs[2].'/Resources/translations/en-US/ShopFormsErrors.en-US.xlf'), 172 => ($this->targetDirs[2].'/Resources/translations/en-US/ShopFormsHelp.en-US.xlf'), 173 => ($this->targetDirs[2].'/Resources/translations/en-US/ShopFormsLabels.en-US.xlf'), 174 => ($this->targetDirs[2].'/Resources/translations/en-US/ShopNavigation.en-US.xlf'), 175 => ($this->targetDirs[2].'/Resources/translations/en-US/ShopNotificationsError.en-US.xlf'), 176 => ($this->targetDirs[2].'/Resources/translations/en-US/ShopNotificationsInfo.en-US.xlf'), 177 => ($this->targetDirs[2].'/Resources/translations/en-US/ShopNotificationsSuccess.en-US.xlf'), 178 => ($this->targetDirs[2].'/Resources/translations/en-US/ShopNotificationsWarning.en-US.xlf'), 179 => ($this->targetDirs[2].'/Resources/translations/en-US/ShopPdf.en-US.xlf'), 180 => ($this->targetDirs[2].'/Resources/translations/en-US/ShopThemeActions.en-US.xlf'), 181 => ($this->targetDirs[2].'/Resources/translations/en-US/ShopThemeCatalog.en-US.xlf'), 182 => ($this->targetDirs[2].'/Resources/translations/en-US/ShopThemeCategory.en-US.xlf'), 183 => ($this->targetDirs[2].'/Resources/translations/en-US/ShopThemeCheckout.en-US.xlf'), 184 => ($this->targetDirs[2].'/Resources/translations/en-US/ShopThemeCustomeraccount.en-US.xlf'), 185 => ($this->targetDirs[2].'/Resources/translations/en-US/ShopThemeGlobal.en-US.xlf'), 186 => ($this->targetDirs[2].'/Resources/translations/en-US/messages.en-US.xlf')], 'pl-PL' => [0 => ($this->targetDirs[2].'/Resources/translations/pl-PL/AdminActions.pl-PL.xlf'), 1 => ($this->targetDirs[2].'/Resources/translations/pl-PL/AdminAdvparametersFeature.pl-PL.xlf'), 2 => ($this->targetDirs[2].'/Resources/translations/pl-PL/AdminAdvparametersHelp.pl-PL.xlf'), 3 => ($this->targetDirs[2].'/Resources/translations/pl-PL/AdminAdvparametersNotification.pl-PL.xlf'), 4 => ($this->targetDirs[2].'/Resources/translations/pl-PL/AdminCatalogFeature.pl-PL.xlf'), 5 => ($this->targetDirs[2].'/Resources/translations/pl-PL/AdminCatalogHelp.pl-PL.xlf'), 6 => ($this->targetDirs[2].'/Resources/translations/pl-PL/AdminCatalogNotification.pl-PL.xlf'), 7 => ($this->targetDirs[2].'/Resources/translations/pl-PL/AdminDashboardFeature.pl-PL.xlf'), 8 => ($this->targetDirs[2].'/Resources/translations/pl-PL/AdminDashboardHelp.pl-PL.xlf'), 9 => ($this->targetDirs[2].'/Resources/translations/pl-PL/AdminDashboardNotification.pl-PL.xlf'), 10 => ($this->targetDirs[2].'/Resources/translations/pl-PL/AdminDesignFeature.pl-PL.xlf'), 11 => ($this->targetDirs[2].'/Resources/translations/pl-PL/AdminDesignHelp.pl-PL.xlf'), 12 => ($this->targetDirs[2].'/Resources/translations/pl-PL/AdminDesignNotification.pl-PL.xlf'), 13 => ($this->targetDirs[2].'/Resources/translations/pl-PL/AdminGlobal.pl-PL.xlf'), 14 => ($this->targetDirs[2].'/Resources/translations/pl-PL/AdminGlobalError.pl-PL.xlf'), 15 => ($this->targetDirs[2].'/Resources/translations/pl-PL/AdminInternationalFeature.pl-PL.xlf'), 16 => ($this->targetDirs[2].'/Resources/translations/pl-PL/AdminInternationalHelp.pl-PL.xlf'), 17 => ($this->targetDirs[2].'/Resources/translations/pl-PL/AdminInternationalNotification.pl-PL.xlf'), 18 => ($this->targetDirs[2].'/Resources/translations/pl-PL/AdminLoginFeature.pl-PL.xlf'), 19 => ($this->targetDirs[2].'/Resources/translations/pl-PL/AdminLoginNotification.pl-PL.xlf'), 20 => ($this->targetDirs[2].'/Resources/translations/pl-PL/AdminModulesFeature.pl-PL.xlf'), 21 => ($this->targetDirs[2].'/Resources/translations/pl-PL/AdminModulesHelp.pl-PL.xlf'), 22 => ($this->targetDirs[2].'/Resources/translations/pl-PL/AdminModulesNotification.pl-PL.xlf'), 23 => ($this->targetDirs[2].'/Resources/translations/pl-PL/AdminNavigationFooter.pl-PL.xlf'), 24 => ($this->targetDirs[2].'/Resources/translations/pl-PL/AdminNavigationHeader.pl-PL.xlf'), 25 => ($this->targetDirs[2].'/Resources/translations/pl-PL/AdminNavigationMenu.pl-PL.xlf'), 26 => ($this->targetDirs[2].'/Resources/translations/pl-PL/AdminNavigationNotification.pl-PL.xlf'), 27 => ($this->targetDirs[2].'/Resources/translations/pl-PL/AdminNavigationSearch.pl-PL.xlf'), 28 => ($this->targetDirs[2].'/Resources/translations/pl-PL/Ad

    ...
    protected function getTwig_LoaderService()
    {
        ...
        $a->addPath(($this->targetDirs[2].'/../src/PrestaShopBundle/Resources/views/Admin/TwigTemplateForm'), 'Twig');
        $a->addPath(($this->targetDirs[2].'/../src/PrestaShopBundle/Resources/views/Admin/Common'), 'Common');
        $a->addPath(($this->targetDirs[2].'/../src/PrestaShopBundle/Resources/views/Admin/Configure/AdvancedParameters'), 'AdvancedParameters');
        $a->addPath(($this->targetDirs[2].'/../src/PrestaShopBundle/Resources/views/Admin/Configure/ShopParameters'), 'ShopParameters');
        $a->addPath(($this->targetDirs[2].'/../modules'), 'Modules');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('6G5XKA0FjOP03LLtNj7p0hff4L7G8aiRSqCwEOhK3WOjaQLzC8qR7p30wxy8mx9o');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'admin_page': $value = ($this->targetDirs[2].'/../src/PrestaShopBundle/Resources/views/Admin'); break;
            ...
            case 'modules_translation_paths': $value = [
                ...
                51 => ($this->targetDirs[3].'/modules/ets_blog/translations'),
                52 => ($this->targetDirs[3].'/modules/whyUs/translations'),
                53 => ($this->targetDirs[3].'/modules/pc_stripeFeatures/translations'),
                54 => ($this->targetDirs[3].'/modules/pc_talkToExperts/translations'),
                55 => ($this->targetDirs[3].'/modules/pc_herosection/translations'),
                56 => ($this->targetDirs[3].'/modules/pc_results/translations'),
                57 => ($this->targetDirs[3].'/modules/pc_usingfb/translations'),
                58 => ($this->targetDirs[3].'/modules/pc_whyUs/translations'),
                59 => ($this->targetDirs[3].'/modules/pc_textSection/translations'),
                60 => ($this->targetDirs[3].'/modules/pc_ourStrenght/translations'),
                61 => ($this->targetDirs[3].'/modules/pc_simpleUse/translations'),
                62 => ($this->targetDirs[3].'/modules/productcomments/translations'),
                63 => ($this->targetDirs[3].'/modules/pc_happycilents/translations'),
                64 => ($this->targetDirs[3].'/modules/ps_crossselling/translations'),
                65 => ($this->targetDirs[3].'/modules/ac_googletagmanager/translations'),
                66 => ($this->targetDirs[3].'/modules/labmegamenu/translations'),
                67 => ($this->targetDirs[3].'/modules/pdgoogleanalytycs4pro/translations'),
                68 => ($this->targetDirs[3].'/modules/thecheckout/translations'),
                69 => ($this->targetDirs[3].'/modules/pricewars2/translations'),
                70 => ($this->targetDirs[3].'/modules/facebookpixelinstaller/translations'),
                71 => ($this->targetDirs[3].'/modules/pscartabandonmentpro/translations'),
                72 => ($this->targetDirs[3].'/modules/pdgoolgedynamicremarketingpro/translations'),
                73 => ($this->targetDirs[3].'/modules/tpay/translations'),
                74 => ($this->targetDirs[3].'/modules/ceneo_trustedreviews/translations'),
                75 => ($this->targetDirs[3].'/modules/x13googlemerchant/translations'),
                76 => ($this->targetDirs[3].'/modules/pdceneozaufaneopiniepro/translations'),
                77 => ($this->targetDirs[3].'/modules/x13popup/translations'),
                78 => ($this->targetDirs[3].'/modules/ceneotrustedreviews/translations'),
                79 => ($this->targetDirs[3].'/modules/smartsupp/translations'),
                80 => ($this->targetDirs[3].'/modules/uecookie/translations'),
            ]; break;
            case 'session.save_path': $value = ($this->targetDirs[0].'/sessions'); break;
            case 'validator.mapping.cache.file': $value = ($this->targetDirs[0].'/validation.php'); break;
            case 'translator.default_path': $value = ($this->targetDirs[3].'/translations'); break;
            case 'profiler.storage.dsn': $value = ('file:'.$this->targetDirs[0].'/profiler'); break;
            case 'debug.container.dump': $value = ($this->targetDirs[0].'/legacyAppDevDebugProjectContainer.xml'); break;
            ...
            case 'ps_root_dir': $value = ($this->targetDirs[2].'/../'); break;
            case 'ps_config_dir': $value = ($this->targetDirs[2].'/../config'); break;
            case 'translations_dir': $value = ($this->targetDirs[2].'/Resources/translations'); break;
            case 'themes_translations_dir': $value = ($this->targetDirs[0].'/themes'); break;
            case 'modules_dir': $value = ($this->targetDirs[2].'/../modules'); break;
            case 'themes_dir': $value = ($this->targetDirs[2].'/../themes'); break;
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.container_class' => 'legacyAppDevDebugProjectContainer',
            'kernel.active_modules' => [
                ...
                72 => 'pc_happycilents',
                73 => 'ps_crossselling',
                74 => 'ac_googletagmanager',
                75 => 'labmegamenu',
                76 => 'smartblogaddthisbutton',
                77 => 'smartblogarchive',
                78 => 'smartblogcategories',
                79 => 'smartblogfeed',
                80 => 'smartbloghomelatestnews',
                81 => 'smartbloglatestcomments',
                82 => 'smartblogpopularposts',
                83 => 'smartblogrecentposts',
                84 => 'smartblogsearch',
                85 => 'smartblogtag',
                86 => 'pdgoogleanalytycs4pro',
                87 => 'thecheckout',
                88 => 'pricewars2',
                89 => 'facebookpixelinstaller',
                90 => 'pscartabandonmentpro',
                91 => 'pdgoolgedynamicremarketingpro',
                92 => 'fulfillmentbyfhb',
                93 => 'tpay',
                94 => 'ceneo_trustedreviews',
                95 => 'x13googlemerchant',
                96 => 'pdceneozaufaneopiniepro',
                97 => 'x13popup',
                98 => 'ceneotrustedreviews',
                99 => 'smartsupp',
                100 => 'uecookie',
            ],
            'container.autowiring.strict_mode' => true,
            'container.dumper.inline_class_loader' => false,
            'database_host' => 'aylonxxnew.mysql.db',
            'database_port' => '',
            'database_name' => 'aylonxxnew',
            'database_user' => 'aylonxxnew',
            'database_password' => 'RTuu8973KLLac',
            'database_prefix' => 'ps_',
            ...
            'secret' => '6G5XKA0FjOP03LLtNj7p0hff4L7G8aiRSqCwEOhK3WOjaQLzC8qR7p30wxy8mx9o',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2023-09-08',
            'locale' => 'pl-PL',
            'use_debug_toolbar' => true,
            'cookie_key' => 'cfWgiaB3ew686tHN8HnqFqYdxg4RwbJ3tFgfiY9xAPnOk1N88CE1GPmHRpghVJrd',
            'cookie_iv' => 'qRde0G7IB9YyFZLmnrfVLRGddoJAk49o',
            'new_cookie_key' => 'def00000eff0a5d4ffb2149670bf33eceba68e89c9b68f3ff4a395566c82d6c3c9387368fcb6de4e373b6405983a2d982e6387c205468ee21ad10069c662c2077251b011',
            'cache.driver' => 'array',
            ...
            'kernel.secret' => '6G5XKA0FjOP03LLtNj7p0hff4L7G8aiRSqCwEOhK3WOjaQLzC8qR7p30wxy8mx9o',
            ...
            'router.options.matcher.cache_class' => 'legacyAppDevDebugProjectContainerUrlMatcher',
            'router.options.generator.cache_class' => 'legacyAppDevDebugProjectContainerUrlGenerator',
            'router.request_context.host' => 'localhost',
            'router.request_context.scheme' => 'http',
            'router.request_context.base_url' => '',
            'router.cache_class_prefix' => 'legacyAppDevDebugProjectContainer',
