...
class legacyAppDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('50pTCsH7rS', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('PEITOIRQeZ', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('X0sBV8DI1Y', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('zMye6s4Qm0', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'modules_translation_paths': $value = [
                ...
                69 => ($this->targetDirs[3].'/modules/paypal/translations'),
                70 => ($this->targetDirs[3].'/modules/pricewars2/translations'),
                71 => ($this->targetDirs[3].'/modules/facebookpixelinstaller/translations'),
                72 => ($this->targetDirs[3].'/modules/pscartabandonmentpro/translations'),
                73 => ($this->targetDirs[3].'/modules/pdgoolgedynamicremarketingpro/translations'),
                74 => ($this->targetDirs[3].'/modules/tpay/translations'),
            ]; break;
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.active_modules' => [
                ...
                88 => 'paypal',
                89 => 'pricewars2',
                90 => 'facebookpixelinstaller',
                91 => 'pscartabandonmentpro',
                92 => 'pdgoolgedynamicremarketingpro',
                93 => 'fulfillmentbyfhb',
                94 => 'tpay',
            ],
