 ...
 */
class legacyAppProdProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('NGHrWSv7VM', 0, ($this->targetDirs[0].'/pools'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_0921be3978e53d3c947502fc1705a04c592f149ee083066a5ead1f5b4c928c85');
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.container_class' => 'legacyAppProdProjectContainer',
            ...
            'router.options.matcher.cache_class' => 'legacyAppProdProjectContainerUrlMatcher',
            'router.options.generator.cache_class' => 'legacyAppProdProjectContainerUrlGenerator',
            'router.request_context.host' => 'localhost',
            'router.request_context.scheme' => 'http',
            'router.request_context.base_url' => '',
            'router.cache_class_prefix' => 'legacyAppProdProjectContainer',
