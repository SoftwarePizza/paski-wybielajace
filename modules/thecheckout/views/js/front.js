...
function _getExtraAccountParams() {
    ...
    if ($('[name=dpd-phone]').length === 1) {
        extraAccountParams += '&dpd-phone=' + encodeURIComponent($('[name=dpd-phone]').val());
    }
    if ($('[name=dpd-phone-area]').length === 1) {
        extraAccountParams += '&dpd-phone-area=' + encodeURIComponent($('[name=dpd-phone-area]').val());
    }
    if ($('[name=dpd-city]').length === 1) {
        extraAccountParams += '&dpd-city=' + encodeURIComponent($('[name=dpd-city]').val());
    }
    if ($('[name=dpd-street]').length === 1) {
        extraAccountParams += '&dpd-street=' + encodeURIComponent($('[name=dpd-street]').val());
    }
