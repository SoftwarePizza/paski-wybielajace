    ...
    public function install()
    {
        ...
        $reassurance_samples = array(
            ...
            'cs' => $this->tagIt('div',
                    ...
                    $this->tagIt('div',
                        $this->tagIt('span', '', 'class="icon"') .
                        $this->tagIt('h3', 'Vrácení zboží') . 'Zboží můžete '. $this->tagIt('b', 'vrátit') . ' v lehote 14 dnů bez uvedení důvodu.',
                        'class="reassurance-section return"'),
                    'class="thecheckout-reassurance"').
                $this->tagIt('p', '*prosím upravte tenhle blok v nastaveních modulu TheCheckout, záložka Rozvržení -> HTML pole č.1 pro jazyk [ Čeština (Czech) ]')
        );
