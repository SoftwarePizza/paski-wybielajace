...
class pc_ourStrenght extends Module
{   
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->l('Sekcja z ikonami');
        ...
        if (!Configuration::get('pc_ourStrenght')) {
    ...
    {   
        $this->context->controller->registerStylesheet(
            'pc-ourStrenght-css',
            'modules/'.$this->name.'/views/css/pc_ourStrenght.css',
            [
              'media' => 'all',
              'priority' => 200,
            ]
    ...
    public function hookDisplayWrapperTop($params)
    {
        if ('index' === $this->context->controller->php_self) {
            return $this->display(__FILE__, 'pc_ourStrenght.tpl');
        }
    }
    public function hookDisplayReassurance($params)
    {   
        if ('product' === $this->context->controller->php_self) {
            return $this->display(__FILE__, 'pc_ourStrenght_product.tpl');
        }
