...
{if $blockCategTree}
    ...
    <div class="block ets_block_categories {$ETS_BLOG_RTL_CLASS|escape:'html':'UTF-8'}">
        <h4 class="title_blog title_block">{l s='Kategorie' mod='ets_blog'}</h4>    
    ...
    {if isset($link_view_all)}
            <div class="blog_view_all_button">
                <a class="blog_view_all" href="{$link_view_all|escape:'html':'UTF-8'}">{l s='Pokaż wszystko' mod='ets_blog'}</a>
            </div>
        </div>    
    </div>
    {/if}
