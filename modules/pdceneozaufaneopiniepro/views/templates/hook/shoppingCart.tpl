...
{if !$only_checkbox}
	<div id="pdceneozaufaneopiniepro" class="box card col-xs-12 col-sm-12 clearfix">
		{if $ps_version_16}
			<fieldset>
		...
		{else}
			<div class="card-block">
				<h1 class="h1">{l s='Acceptance of participation in the Ceneo Trusted Reviews' mod='pdceneozaufaneopiniepro'}</h1>
			</div>
			<hr class="separator">
			<div class="cart-overview-new">
