...
function pricewars2_product(\pricewars2\product $product, $id_xml, $id_lang, $service, $settings, $module){
    ...
    // Nadpisanie kosztów dostawy dla produktu
    ...
    $product->setShippingCollection($sp);
    // Reset kolekcji dostaw. Sklep pobierze automatycznie na podstawie kurierów.
    // $product->resetShippingCollection();
}
